...
- /WEB-INF/user/registerForm.jsp -  _ListCommunityJsonController에 대한 Ajax 호출 추가_
- /WEB-INF/community/list.jsp -  _listAndView.jsp로 교체: ViewCommunityJsonController에 대한 Ajax 호출 실행_
